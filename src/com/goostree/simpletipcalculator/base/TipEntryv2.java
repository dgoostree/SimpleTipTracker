...
public class TipEntryv2 implements Serializable, Comparable<TipEntryv2> {
	...
	private String note;
	private ArrayList<TipoutRecordv2> tipOuts;
	...
	public TipEntryv2(int year, int month, int day, double gTips, double nTips, double hours, double wage, ArrayList<TipoutRecordv2> tips){
	...
	public TipEntryv2(int year, int month, int day){
		Date =  Calendar.getInstance();
		Date.clear();
		Date.set(year, month, day);
		grossTips = 0;
	...
	public ArrayList<TipoutRecordv2> getTipoutInfo(){
		return tipOuts;
	}

	public int compareTo(TipEntryv2 other) {
